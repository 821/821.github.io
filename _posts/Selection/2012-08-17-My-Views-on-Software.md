...
儘管如此，我還是用了很多非常小衆的軟件。不過這些軟件的功能比較難替代，其實也相當於業界主流了，而且多數是小工具類型的。
...
### 開源優於閉源
開源軟件不容易埋藏壞東西，而且一個開發者停止更新了，別人還能繼續。開源是一個趨勢，是人類經過嚴格的版權制度後的一個新走向。開源就像共產，雖然未必現實，畢竟是人類最美好的願景之一，我們何不做做這個美夢？開源軟件，讓我們經常不必苦苦等待商家的更新，如果有需要，上網搜一搜，或者自己寫一寫，新功能就出來了。
就算不開源，起碼給個接口，讓人能比較舒服的修改，比如開放比較多的 API 。
...
## 戰場
講了戰略和戰術，當然要給出戰場實例。
加 $ 的軟件存在版權問題，鏈接僅作說明用。如果你的職業對版權敏感，請上官網購買權限。
...
<a href="http://code.taobao.org/p/MyFirefox/src/" rel="external">Firefox</a> 插件多又好。
→<a href="http://code.taobao.org/p/mychrome/src/" rel="external">Chrome</a> 用起來比較舒服。
...
<a href="http://winscp.net/" rel="external">WinSCP</a> 專門用他的命令行。
→$Winrar 簡單好用，用戶習慣無敵。
