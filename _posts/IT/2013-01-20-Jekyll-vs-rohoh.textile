...
"Markdown 中文版":http://markdown.tw/ "Markdown":http://daringfireball.net/projects/markdown/syntax "Textile":http://txstyle.org/ "html":http://www.w3schools.com/html/default.asp "代碼高亮 Pygments":http://pygments.org/docs/lexers/
...
Liquid: "原版":https://github.com/shopify/liquid/wiki/liquid-for-designers "Jekyll 加強版":https://github.com/mojombo/jekyll/wiki/Liquid-Extensions
Note: Jekyll 官方 Liquid 文檔寫的所有 @page@ 的屬性都適用於 @post@ 。



h3. 部署進階教程
"Openshift":http://shawhu.org/2012-10/Jekyll-OpenShift/ "Heroku":http://jonasforsberg.se/2012/07/22/jekyll-heroku-unicorn