...
{% highlight bat %}call git push https://username:password@github.com/username/username.github.com.git{% endhighlight %}
明白爲什麼我要把我的上傳腳本放在文件夾外面了嗎？哦，對了，還有 .gitconfig 要加上：
{% highlight yaml linenos %}[http]
	proxy = 127.0.0.1:8087
	sslVerify = false{% endhighlight %}
具體 proxy 當然是自己設置，我比較懶惰用了 GoAgent 。
基本上 GFW 這次動作對我影響不大，雖然屏蔽了 GitHub ，但我的網站綁定了域名，訪問沒有影響。而 GoAgent 是一直開着的，做好設置後問題不大。這就令人費解了，我一個半句 Ruby 都不會寫、 Pro-Git 都沒讀過的人尚且能通過 Google 和動腦輕鬆解決問題，這次封鎖對用戶以程序猿爲主的 GitHub 到底有什麼屁用？
