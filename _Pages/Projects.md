...
## 尺帛 (Note-)
2015/05/02 開工， 2015/05/06 投入使用。
現有的筆記軟件大多過於沈重，慢，還不能開心的用自己習慣的文本編輯器來編輯。其實用 GFM 來寫，就能實現絕大多數筆記軟件提供的編輯效果，就差個瀏覽窗口而已。網上有人寫了個 Marboo ，設計不錯，但沒有 Windows 版，我就用 Python 寫個更簡單的，衹有一百多行代碼。