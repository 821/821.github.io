...
### 牛刀和雞
讓 TeX 這把牛刀出鞘，你可要想好了，沒必要見了雞就拔牛刀。當然，如果你已經會用牛刀了，殺殺雞也行。
...
比如你要寫 blog ，反正最後都要轉 HTML 的，那就 Markdown 好了。
...
順帶說一下，雖然我不認爲 TeX 太難，不過臺灣有個叫侯捷的程序猿，因覺 TeX 難，就用 Word ，還出了一本叫「 Word 排版藝術」的書（這本書產生的年代 TeX 排中文確實有點煩，但也不至於那麼誇張）——雖然我不認爲 Word 這種字處理軟件做的事能算得上排版，更叫不要說什麼藝術，不過這也說明了 TeX 並非可以一蹴而就的傻瓜軟件。
...
### 入門文檔
<a href="http://www.dralpha.com/zh/tech/lnotes2.pdf" rel="external">lnotes2</a> ，作者姓黃，署名包太雷，個人判斷出生時間不晚於 1970 年，因爲他用了「馬尾巴的功能」 [^3] 的典故。文章風趣詼諧，八卦信手拈來，而且排得較 fancy 。不過他的立場是 XeLaTeX ，直排不如 LuaLaTeX 。
...
`\let`: TeX, 讓一個命令等同於另一命令。用法： `\let\foo=\bar` 。（所以說 Knuth 一定是個像我這麼無聊的人，）
