...
好啦，其實下載沒有那麼麻煩，我花了幾小時學習 Python 並寫了這個下載腳本，輸入 BookNum 就能自動下載到 F:\BookNum 文件夾。 Python 眞是易學易用。
以下腳本使用 Python 2.7 版
<notextile>{% highlight python linenos %}
# -*- coding: utf-8 -*-
...
有時候程序會自己跳出或者出錯，所以加上了續傳功能，以及直接輸入鏈接就能自動改成 @BookNum@ 的功能，還有添加了一些提示，最後再改成 Python 3.4 格式
<notextile>{% highlight python linenos %}
# -*- coding: utf-8 -*-
#使用 Python 3
